        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fa-solid fa-info-circle"></i> Información del {{ ucfirst($aula->tipo) }}</h5>
                </div>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.aula.destroy', $aula) }}"
                          method="POST"
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        ...
                        <div class="progress">
                            @php
                                $ocupacion = $aula->materias->count() > 0 ? min(100, ($aula->materias->count() * 10)) : 0;
                            @endphp
                            <div class="progress-bar" role="progressbar" style="width: {{ $ocupacion }}%" aria-valuenow="{{ $ocupacion }}" aria-valuemin="0" aria-valuemax="100">
                                {{ $ocupacion }}%
                            </div>
                        </div>
                    </div>
                    <hr>
                    <p class="mb-1">
                        <i class="fa-solid fa-book"></i> <strong>{{ $aula->materias->count() }}</strong> materias asignadas
                    </p>
                    <p class="mb-0">
                        <i class="fa-solid fa-users"></i> Capacidad para <strong>{{ $aula->capacidad }}</strong> personas
                    </p>
                </div>
            </div>
        </div>
